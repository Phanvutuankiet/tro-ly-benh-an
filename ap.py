...
with st.form("benh_an_form"):
    ...
    tien_su = st.text_area("Tiền sử", "Tăng huyết áp 10 năm, đái tháo đường type 2, hút thuốc lá 20 gói-năm.", help="Bạn có thể tự do chỉnh sửa hoặc xóa nội dung ví dụ trong ô này.")
